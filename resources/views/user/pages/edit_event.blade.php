    ...
    <div class="row">
        <div class="col mb-n1 mt-n5 mt-md-0">
          <!-- Card -->
            ...
            <div class="card-body">
              <!--Title-->
              <h4 class="card-title text-white font-weight-bold text-center h1">EDIT EVENT</h4>
            </div>
        </div>
          <!-- Card -->
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="md-form">
                                        <input type="text" class="form-control" placeholder="ex : Codora" name="nama_penyelenggara" value="{{ $s->penyelenggara->nama_penyelenggara }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="md-form">
                                        <input type="text" class="form-control" placeholder="ex : 085312341234" name="no_telp_penyelenggara" value="{{ $s->penyelenggara->no_telp_penyelenggara }}">
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-7">
                                    <div class="md-form">
                                        <input type="text" class="form-control" placeholder="ex : No.Rek" name="no_rek_penyelenggara" value="{{ $s->penyelenggara->no_rek_penyelenggara }}">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-center">
                                        <div class="btn btn-mdb-color btn-rounded float-left">
                                            ...
                                            <input type="file" name="logo_penyelenggara" value="{{ $s->penyelenggara->logo_penyelenggara }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="md-form">
                                        <input type="text" value="{{ $s->nama_event }}" placeholder="ex : Dapur Mum" class="form-control" name="nama_event">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="deskripsi_event" name="deskripsi_event">{{ $s->deskripsi_event }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-n4 mt-md-0">
                                    <div class="md-form">
                                        <input type="text" id="waktu_mulai_event" placeholder="Waktu Mulai Event" class="form-control waktu-event" name="waktu_mulai_event" value="{{ $s->waktu_mulai_event }}">
                                        <script>
                                ...
                                <div class="col-md-6 mt-n4 mt-md-0">
                                    <div class="md-form">
                                        <input type="text" id="waktu_berakhir_event" placeholder="Waktu Berakhir Event" class="form-control waktu-event" name="waktu_berakhir_event" value="{{ $s->waktu_berakhir_event }}">
                                        <script>
